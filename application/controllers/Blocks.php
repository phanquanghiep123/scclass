  ...
  public function update_part_block(){
    ...
    if($this->input->is_ajax_request()){
      ...
      if($block_part){
        ...
        $info_part = $this->Common_model->get_record($this->_fix."theme_section_block_part_order",$where );
  ...
  public function save_block_part(){
    ...
    if($this->input->is_ajax_request()){
      ...
      if($bp){
        ...
        $this->Common_model->update($this->_fix."theme_section_block_part_order",$data_update,$where);
