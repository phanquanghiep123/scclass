  ...
  public function get (){
    ...
    if($this->input->is_ajax_request()){
      ...
      if($id){
        ...
        if($p){ 
          $default = ($theme_id  == 0 && $section_block_id == 0) ? 1 : 0;
          $data_insert = [
            "part_id"    => $p["id"],
            "block_id"   => $block_id,
            "ramkey"     => $ramkey,
          ...
          if($part_id){
            ...
            $this->Common_model->add($this->_fix."theme_section_block_part_order",$insert_data);
            if($actions != null){
          ...
          if($block_part){
            ...
            if($part){
              ...
              $actions = $this->Parts_model->get_action_like($id, $section_block_id ,$theme_id);
              if($actions){
